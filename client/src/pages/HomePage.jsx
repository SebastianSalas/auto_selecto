...
export default function HomePage() {
    ...
    return(
        <>
          <header className="py-6 px-10 flex items-center fixed top-0 w-full justify-between z-50">
            ...
            <section className="text-center h-screen w-screen relative overflow-hidden">
              <div className='z-30 relative h-full flex flex-col '>
                ...
                <footer className='flex flex-col flex-grow justify-end pb-24'>
                  <div>
                    <a className='border-2 border-white bg-white/5 backdrop-blur-3xl text-sm rounded font-medium px-6 py-2 inline-block' href="#">
              ...
              <div className='absolute top-0 bottom-0 z-10 opacity-50 h-full w-full'>
                <video loop muted autoPlay className='object-cover object-center h-full w-full'>
